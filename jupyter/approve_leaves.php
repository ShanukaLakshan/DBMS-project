<<<<<<< Updated upstream:jupyter/approve_leaves.php
<?php 
...
<body>
  ...
  <?php } ?>
    ...
    <a class="active" href="./approve_leaves.php"><p style="font-size:small"><i class="fa fa-clock-o fa-2x mt-1" aria-hidden="true"></i><br>Pending Approvals</p></a>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($leaves)) { ?>
                                                    <tr>
                                                        <th scope="row"><?= $i ?></th>
                                                        <td><?php echo $row["id"]; ?></td>
                                                        <td><?php echo mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM employee WHERE id=".$row["id"].""))['first_name']." ".mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM employee WHERE id=".$row["id"].""))['last_name']; ?></td>                                                        
...
>>>>>>> Stashed changes:jupiter/approve_leaves.php
</html>