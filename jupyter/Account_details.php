<<<<<<< Updated upstream:jupyter/Account_details.php
<?php 
...
<body>
  ...
  <?php } ?>
    ...
    <a href="./approve_leaves.php"><p style="font-size:small"><i class="fa fa-clock-o fa-2x mt-1" aria-hidden="true"></i><br>Pending Approvals</p></a>
        <?php 
                ...
                <div class="row mx-0 text-end">
                    ...
                    <div class="col-lg-auto text-end align-content-end" style="margin-left:-4%;">
                        <div class="dropdown align-self-end" style="float:right">
                            <button class="dropbtn align-self-end">
                                <p style="color:white">
                                    <?php echo $emprow['first_name'].' '.$emprow['last_name'] ?> &nbsp<i class="fa fa-caret-down"></i>
                                </p>
                            </button>
                            <div class="dropdown-content" style="left:0px">
                                <a href="#">Account details</a>
                            ...
                            <span class="img-div">
                                ...
                                <div class="container" style="position: relative;">
                                        <?php
                                            ...
                                            $ext = pathinfo($name, PATHINFO_EXTENSION);
                                            if (!empty($img)){
                                                echo "<img src='data:image/" . $ext . ";base64," . $img . "' height='auto' width='300px' class='rounded-circle' onClick='triggerClick()'' id='profileDisplay' alt='...'/>";
                                              }
                                              else{
                                                echo "<img src='./img/user-default.png' height='auto' width='300px' id='profileDisplay' onClick='triggerClick()' class='rounded-circle' alt='...'/>";
                                              }                                            ?>
                                    </div>
                            </span>
                            <input type="file" name="profileImage" onChange="displayImage(this)" id="profileImage"
...
>>>>>>> Stashed changes:jupiter/Account_details.php
