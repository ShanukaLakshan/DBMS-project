...
<body>
    ...
    <div class="content">
        <div class="row col-lg-15 " style="background-color:#EFF5F5">
            <div class="col">
              ...
              <div class="row mx-0 text-end">
                ...
                <div class="col-lg-auto text-end align-content-end" style="margin-left:-4%;" >
                  <div class="dropdown align-self-end" style="float:right">
                    <button class="dropbtn align-self-end"> <?php echo $row['name'] ?> &nbsp<i class="fa fa-caret-down"></i> </button>
        ...
        <div class="container-fluid mx-0" >
            <div class="row" style="margin-top:1%">
                <div class="col">
                    <div class="card rounded-3" style="padding: 2%;background-color: rgba(255, 255, 255, 0.519);">
                        <div class="row">
                                <div class="col justify-content-md-start">
                                    <div class="card" style="padding:2%">
                                        ...
                                        ?>
                                            ...
                                            <h6 class="card-title" style="margin-top: -5px;"><?php echo $username ?></h6>
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                          <div class="row">
                                            ...
                                            <div class="progress">
                                              <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow= '<?php echo $leaves['no_pay']-$nopayc['count'] ?>' aria-valuemin="0" aria-valuemax="100" style="width: <?php echo ($leaves['no_pay']-$nopayc['count'])/$leaves['no_pay']*100 ?>%">
                                          ...
                                          <div class="row " style="margin-top:10px">
                                            ...
                                            <div class="progress">
                                            <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow= '<?php echo $leaves['annual']-$annualc['count'] ?>' aria-valuemin="0" aria-valuemax="100" style="width: <?php echo ($leaves['annual']-$annualc['count'])/$leaves['annual']*100 ?>%">
                                        ...
                                        <div class="row " style="margin-top:10px">
                                          ...
                                          <div class="progress">
                                          <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow= '<?php echo $leaves['casual']-$casualc['count'] ?>' aria-valuemin="0" aria-valuemax="100" style="width: <?php echo ($leaves['casual']-$casualc['count'])/$leaves['casual']*100 ?>%">
                                      ...
                                      <div class="row " style="margin-top:10px">
                                        ...
                                        <div class="progress">
                                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow= '<?php echo $leaves['maternity']-$maternityc['count'] ?>' aria-valuemin="0" aria-valuemax="100" style="width: <?php echo ($leaves['maternity']-$maternityc['count'])/$leaves['maternity']*100 ?>%">
